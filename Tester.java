...
public class Tester 
{
    ...
    public static void main (String[] args)
    {
        ...
        {
            if (!randomized)
                placeBoard.placePiece(shipSet[i], inputSource); //i give up lets just pass scanner in. also apparently ur not supposed to have multiple scanners or else they'll eat everything. WHOOPS
        }
